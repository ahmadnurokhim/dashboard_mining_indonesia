...
with mid2b:
    ...
    "Apabila kita telusuri lebih lanjut, batubara kembali menarik perhatian. Volume ekspor batubara sendiri mencakup lebih dari separuh volume ekspor mineral non migas Indonesia. Hal ini menyoroti pentingnya peran batubara dalam perekonomian negara."
'---'
